      ...
      <article className="relative z-10">
        ...
        <header className="container mx-auto px-6 pt-10 pb-20">
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-t border-white/10 pt-8 mt-12"
            >
            ...
            <div className="md:col-span-2 space-y-12">
              ...
              >
                ...
                <div className="prose prose-invert prose-lg text-gray-300 leading-relaxed">
                  ...
                  <p className="mt-4">
                    Designed with a focus on user experience and visual
                    hierarchy, this project represents a deep dive into modern
                    web technologies. The goal was to create something that not
                    only functions perfectly but also leaves a lasting
                    impression on the user. Every interaction is micro-managed
                    to ensure smoothness and reliability.
                  </p>
                </div>
              </motion.div>
                ...
                {project.gallery.map((img, idx) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <span className="text-white font-mono text-sm tracking-widest border border-white/30 px-4 py-2 rounded-full backdrop-blur-md">
                        VIEW
                      </span>
                    </div>
                  </motion.div>
        ...
        <section className="border-t border-white/10">
          <div className="container mx-auto px-6 py-20">
            <div className="text-center">
              <p className="text-gray-500 font-mono mb-4 text-sm">
                NEXT PROJECT
              </p>
              {/* Ideally logic to find next project, for now linking to home or a static one */}
              <Link
                href="/#projects"
                className="text-4xl md:text-6xl font-black hover:text-purple-400 transition-colors"
              >
                View All Work
              </Link>
            </div>
