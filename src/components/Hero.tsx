...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-[#050505] font-sans pt-20 pb-20 md:pb-0 lg:pb-0 md:pt-0">
      {/* Background Layer */}
