  ...
  return (
    ...
    >
      ...
      <div className="relative bg-[#0d0d0d]/40 backdrop-blur-2xl border border-white/10 p-8 rounded-2xl h-full flex flex-col items-center text-center hover:border-white/20 transition-all duration-500 shadow-2xl">
        ...
        <h3 className="text-xl font-bold text-white mb-2 tracking-tight group-hover:tracking-wide transition-all duration-300">
          {skill.name}
        </h3>

        <p className="text-gray-400 text-sm leading-relaxed mb-6 font-light group-hover:text-gray-200 transition-colors">
          {skill.description ||
            "Building high-performance modern web solutions."}
        </p>
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        style={{
          background:
            "conic-gradient(from 0deg, transparent 0deg, #a855f7 120deg, transparent 180deg, #06b6d4 300deg, transparent 360deg)",
          filter: "blur(80px)",
        }}
      />
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 text-lg font-light leading-relaxed">
              A comprehensive look at my technical expertise as a{" "}
              <span className="text-white">Frontend & WordPress Developer</span>{" "}
              with 2.6+ years of industry experience.
            </p>
          </motion.div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {(skillsData as any)[activeCategory].map(
