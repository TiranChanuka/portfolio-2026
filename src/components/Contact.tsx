...
const Contact = () => {
  ...
  const sendEmail = (e: React.FormEvent) => {
    ...
    // Add these to your .env.local as NEXT_PUBLIC_EMAILJS_SERVICE_ID, NEXT_PUBLIC_EMAILJS_TEMPLATE_ID, NEXT_PUBLIC_EMAILJS_PUBLIC_KEY
    ...
    if (!SERVICE_ID || !TEMPLATE_ID || !PUBLIC_KEY) {
      console.error(
        "EmailJS env vars missing. Please set NEXT_PUBLIC_EMAILJS_SERVICE_ID, NEXT_PUBLIC_EMAILJS_TEMPLATE_ID and NEXT_PUBLIC_EMAILJS_PUBLIC_KEY",
      );
      setError(true);
      setLoading(false);
      return;
    ...
    // Initialize EmailJS (optional - sendForm also accepts public key as 4th arg)
    try {
      if (emailjs.init) emailjs.init(PUBLIC_KEY);
    } catch (err) {
      // continue, sendForm will still work if init isn't necessary
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <span className="text-cyan-400 font-mono tracking-widest uppercase mb-2 block text-xs">
              Get In Touch
            </span>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-10">
                  ...
                  just want to say hi, I'm always open to chatting.
                </p>
                ...
                <div className="flex gap-3">
                  {[FaGithub, FaLinkedin, FaTwitter].map((Icon, i) => (
                    <a
                      key={i}
                      href="#"
                      className="w-10 h-10 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center text-gray-400 hover:bg-white hover:text-black transition-all"
                    >
                      <Icon size={18} />
                    </a>
                  ))}
