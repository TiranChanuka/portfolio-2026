...
const About = () => {
  ...
  const socialLinks = [
    ...
    {
      icon: <FaEnvelope />,
      url: "mailto:tiranchanukaw@gmail.com",
      color: "hover:text-white",
    },
    {
      icon: <FaPhone />,
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <p className="text-xl text-gray-300 leading-relaxed font-light">
                Versatile Frontend & WordPress Developer combining 2.6+ years of
                industry experience with 5+ years of freelance expertise. I
                specialize in engineering high-performance web solutions by
                bridging robust backend logic (Custom Plugins, PHP) with modern,
                interactive frontend (React.js, Next.js). A proven
                problem-solver focused on scalable architectures, SEO
                optimization, and delivering pixel-perfect user experiences.
              </p>
            </motion.div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-8 flex items-center gap-3">
                <FaGraduationCap className="text-purple-400" /> Education &
                Certifications
              </h3>
