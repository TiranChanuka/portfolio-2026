...
export const projectsData: Project[] = [
  {
    ...
    story:
      "Bloom Hub's design is all about beauty and simplicity. The interface lets the flowers be the star, with a minimalist layout that doesn't distract from the colorful product images. The purchasing flow is streamlined to ensure that sending a gift is a joyful experience.",
  },
  {
    id: 2,
    year: "2024",
    ...
    story:
      "EcoGuide allows users to track their environmental impact. The UI uses earth tones and organic shapes to reinforce the sustainability theme. Features like carbon footprint calculators and daily eco-tips are presented in a clear, non-intimidating way to encourage positive behavior change.",
  },
  {
    id: 3,
    year: "2024",
    ...
    story:
      "EduLearn's UI is centered around the student experience. The design organizes complex course material into digestible modules. Navigation is intuitive, and the progress tracking features use encouraging visuals to keep learners motivated.",
  },
  {
    id: 4,
    year: "2024",
    ...
    story:
      "These splash screens are designed to make users hungry! Using appetizing imagery and bold branding, the design sets the tone for a quick and satisfying food delivery experience. The animations and transitions were conceptually planned to feel snappy and responsive.",
  },
  {
    id: 5,
    year: "2024",
    ...
    story:
      "This UI kit focuses on the critical first impression: the authentication flow. It includes designs for login, registration, password recovery, and social auth, all crafted to minimize user friction and maximize conversion rates with a friendly and trustworthy aesthetic.",
  },
  {
    id: 6,
    year: "2024",
    ...
    story:
      "The Car Blog UI is designed for automotive enthusiasts. It features a clean, grid-based layout for articles, high-impact imagery, and an engaging comment section. The typography and spacing are optimized for readability across devices.",
  },
  {
    id: 7,
    year: "2024",
    ...
    story:
      "This design project focused on creating a frictionless digital wallet experience. The UI emphasizes clarity, security, and speed. Key screens designed include the dashboard, transaction history, and money transfer flows, all adhering to modern design principles with a vibrant color palette.",
  },
  {
    id: 8,
    year: "2024 - 2025",
    ...
    story:
      "Mandara Tours provides a reliable taxi service platform. The website features fare estimation tools, vehicle options, and instant booking forms. It is optimized for mobile users who need to book transportation on the go.",
  },
  {
    id: 9,
    year: "2024",
    ...
    story:
      "This website connects adventure seekers with Udawalawe's premier safari tours. It offers detailed tour itineraries, pricing information, and an easy-to-use booking inquiry form. The design focuses on showcasing the wildlife and natural beauty of the park.",
  },
  {
    id: 10,
    year: "2025",
    ...
    story:
      "Silver Sparkles is an online jewelry store built for elegance and ease of use. The frontend, powered by React and Tailwind, showcases intricate product details through high-quality image galleries. The shopping experience is smooth, from browsing collections to the final checkout step.",
  },
  {
    id: 11,
    year: "2024",
    ...
    story:
      "Little Rose Inn's website provides a complete booking solution for guests. It includes an intuitive room availability calendar, a secure booking engine, and a section for customer testimonials. The site helps streamline hotel operations and enhances the guest booking experience.",
  },
  {
    id: 12,
    year: "2025",
    ...
    story:
      "KNC Gaming's website serves as a hub for gaming enthusiasts. It features comprehensive game reviews, community event schedules, and forums. The site leverages WordPress for content management, customized with CSS and Elementor to appeal to the gaming demographic with a dynamic and edgy aesthetic.",
  },
  {
    id: 13,
    year: "2024",
  ...
  },
  {
    ...
    story:
      "Hari Capital's loan management system streamlines the lending process. It features secure user authentication, real-time loan tracking, and detailed payment history logs. The application was built with React and TypeScript for reliability, while Ant Design components provided a professional and consistent look and feel.",
  },
  {
    id: 15,
    year: "2024 - 2025",
  ...
  },
  {
    ...
    title: "Nova Mind",
    slug: "nova-mind",
    description: "NovaMind AI is a premium, high-performance landing page",
    image: "/Projects/Nova Mind.png",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    category: "Frontend",
    liveUrl: "https://nova-mind-ai-livid.vercel.app/",
    gallery: ["/Projects/Nova Mind.png"],
    story:
      "NovaMind AI is a premium, high-performance landing page designed for AI-driven solutions. Built with cutting-edge technologies like Next.js 15, Tailwind CSS 4, and Framer Motion, it offers a stunning visual experience with smooth animations and a responsive design.",
  },
  {
    id: 18,
    year: "2026",
    title: "Mistiora Tours",
    slug: "mistiora-tours",
    description:
      "A WordPress website for a tour company, featuring tour packages, booking forms, and customer testimonials.",
    image: "/Projects/Mistiora tours.png",
